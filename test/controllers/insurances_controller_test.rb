...
class InsurancesControllerTest < ActionController::TestCase
  ...
  test "should create insurance" do
    assert_difference('Insurance.count') do
      post :create, insurance: { age: @insurance.age, carrier: @insurance.carrier, monthly_premium: @insurance.monthly_premium, plan: @insurance.plan, region: @insurance.region }
    end
  ...
  test "should update insurance" do
    patch :update, id: @insurance, insurance: { age: @insurance.age, carrier: @insurance.carrier, monthly_premium: @insurance.monthly_premium, plan: @insurance.plan, region: @insurance.region }
    assert_redirected_to insurance_path(assigns(:insurance))
  end
